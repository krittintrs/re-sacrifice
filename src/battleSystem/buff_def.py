...
CARD_BUFF = {
    ...
    'range_boost': BuffConf('+2 RANGE', 2, [0, 0, 0, 0, 2], gBuffIcon_image_list['range']),
    ...
    'range_debuff': BuffConf('-2 RANGE', 2, [0, 0, 0, 0, -2], gBuffIcon_image_list['range']),
    ...
    'blood_buff': BuffConf('Blood Buff', 1, [0, 0, 0, 0, 0], gBuffIcon_image_list['attack']),
    'crit+': BuffConf('Critical+ (4/6 chance)', 2,[0, 0, 0, 0, 0], gBuffIcon_image_list['critical']),
    'critical_buff': BuffConf('Critical (x1.5 ATK)', 1,[0, 0, 0, 0, 0], gBuffIcon_image_list['critical']),
    'sabotage': BuffConf('Sabotage Move (Shift Range +1)', 2, [0, 0, 0, 1, 1], gBuffIcon_image_list['range']),
}