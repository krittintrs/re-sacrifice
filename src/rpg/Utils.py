...
class SpriteManager:
    def __init__(self):
        self.spriteCollection = self.loadSprites(
            [
                "./src/rpg/sprite/Classes/CharacterAnimation.json",
                "./src/rpg/sprite/Classes/mageAnimation.json",
                "./src/rpg/sprite/Classes/warriorAnimation.json",
                "./src/rpg/sprite/Classes/rangerAnimation.json"
            ]
        )
